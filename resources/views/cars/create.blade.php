    ...
    <div class="glass-card p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <input type="date" name="document_received_at" id="document_received_at" value="{{ old('document_received_at') }}" 
                       class="form-input w-full">
            </div>
            ...
            <div>
                ...
                <input type="date" name="document_issued_at" id="document_issued_at" value="{{ old('document_issued_at') }}" 
                       class="form-input w-full">
            </div>
    ...
    <div class="glass-card p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <input type="text" name="vessel" id="vessel" value="{{ old('vessel') }}" 
                       class="form-input w-full">
            </div>
    ...
    <div class="glass-card p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <input type="number" name="dealer_profit" id="dealer_profit" value="{{ old('dealer_profit', 0) }}" 
            ...
            <div>
                ...
                <input type="number" name="transfer_commission" id="transfer_commission" value="{{ old('transfer_commission', 0) }}" 
                       class="form-input w-full" step="0.01" min="0">
            </div>
