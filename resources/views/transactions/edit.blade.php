...
<form method="POST" action="{{ route('transactions.update', $transaction) }}" class="max-w-xl space-y-6">
    ...
    <div class="glass-card p-6 space-y-4">
        ...
        <div>
            ...
            <input type="text" name="payment_date" value="{{ old('payment_date', $transaction->payment_date?->format('Y-m-d')) }}" autocomplete="off" class="form-input w-full date-input" placeholder="dd/mm/yyyy" required>
        </div>
