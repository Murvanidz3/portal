...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <div class="stat-card">
            <div class="flex items-center justify-between">
                <div class="min-w-0 flex-1 pr-2">
                    <p class="text-xs font-medium text-dark-400 uppercase tracking-wider truncate">სულ ღირებულება</p>
                    <p class="text-lg lg:text-2xl font-bold text-white mt-1">${{ number_format($stats['total_cost'], 2) }}</p>
                </div>
                <div class="w-9 h-9 lg:w-12 lg:h-12 flex-shrink-0 rounded-xl bg-blue-500/20 flex items-center justify-center">
                    <svg class="w-4 h-4 lg:w-6 lg:h-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z"/>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0"/>
                    </svg>
                </div>
        ...
        <div class="stat-card">
            <div class="flex items-center justify-between">
                <div class="min-w-0 flex-1 pr-2">
                    <p class="text-xs font-medium text-dark-400 uppercase tracking-wider truncate">გადახდილი</p>
                    <p class="text-lg lg:text-2xl font-bold text-green-400 mt-1">${{ number_format($stats['total_paid'], 2) }}</p>
                </div>
                <div class="w-9 h-9 lg:w-12 lg:h-12 flex-shrink-0 rounded-xl bg-green-500/20 flex items-center justify-center">
                    <svg class="w-4 h-4 lg:w-6 lg:h-6 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                    </svg>
                </div>
            </div>
        ...
        <div class="stat-card">
            <div class="flex items-center justify-between">
                <div class="min-w-0 flex-1 pr-2">
                    <p class="text-xs font-medium text-dark-400 uppercase tracking-wider truncate">დავალიანება</p>
                    <p class="text-lg lg:text-2xl font-bold mt-1 {{ $stats['total_debt'] > 0 ? 'text-red-400' : 'text-green-400' }}">
                        ${{ number_format($stats['total_debt'], 2) }}
                    </p>
                </div>
                <div class="w-9 h-9 lg:w-12 lg:h-12 flex-shrink-0 rounded-xl bg-red-500/20 flex items-center justify-center">
                    <svg class="w-4 h-4 lg:w-6 lg:h-6 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                </div>
            </div>
        ...
        <div class="stat-card">
            <div class="flex items-center justify-between">
                <div class="min-w-0 flex-1 pr-2">
                    <p class="text-xs font-medium text-dark-400 uppercase tracking-wider truncate">სულ მანქანები</p>
                    <p class="text-lg lg:text-2xl font-bold text-yellow-400 mt-1">{{ $stats['total_cars'] }}</p>
                </div>
                <div class="w-9 h-9 lg:w-12 lg:h-12 flex-shrink-0 rounded-xl bg-yellow-500/20 flex items-center justify-center">
                    <svg class="w-4 h-4 lg:w-6 lg:h-6 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
